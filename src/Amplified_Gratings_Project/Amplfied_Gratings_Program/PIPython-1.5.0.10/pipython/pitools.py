...
from pipython.gcscommands import getgcsheader, getitemsvaluestuple
from pipython.piparams import applyconfig
...
__signature__ = 0x76e76c985a5648a0a00c0ef573815e98
...
def piwrite(filepath, text):
    ...
    with open(filepath, 'w', encoding='utf-8', newline='\n') as fobj:
        try:
            fobj.write(text.encode('cp1252').decode('cp1252'))
