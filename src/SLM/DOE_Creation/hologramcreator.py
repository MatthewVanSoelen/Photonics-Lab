...
##############################################################################
    ...
    def __init__(self, root:tk.Tk, configs:dict):
        ...
        if 'Window Title' not in configs:
            configs['Window Title'] = ('DOE Creator')
...
##############################################################################
    ...
    def setup_grating_options(self, frame:tk.Frame):
        ...
        tk.Label(frame, text='Exposure time (s)', font='bold').grid(row=0, column=0)
        self.entry_exp_time = tk.Entry(frame, width = 15)
        self.entry_exp_time.grid(row=0, column = 1)
        
        tk.Label(frame, text="Laser Power (?)", font='bold').grid(row=1, column=0)
        self.entry_laser_power = tk.Entry(frame, width = 15)
        self.entry_laser_power.grid(row=1, column=1)

        tk.Label(frame, text='Vertical step-size', font='bold').grid(row=2, column=0)
        self.entry_ver_step = tk.Entry(frame, width = 15)
        self.entry_ver_step.grid(row=2, column = 1)

        tk.Label(frame, text='Horizontal step-size', font='bold').grid(row=3, column=0)
        self.entry_hor_step = tk.Entry(frame, width = 15)
        self.entry_hor_step.grid(row=3, column = 1)
    ...
    def setup_experiment_details_view(self, frame:tk.Frame):
        ...
        self.folder_name_label = tk.Label(sub_frame, text = "Folder Name: ")
        self.folder_name_label.grid(row=1, column=0)
        self.file_name_label = tk.Label(sub_frame, text = "File Name: ")
        self.file_name_label.grid(row=2, column=0)
        
        self.id_label = tk.Label(sub_frame, text= "id #: ")
        self.id_label.grid(row=3, column=0)
        self.x_label = tk.Label(sub_frame, text = "X: ")
        self.x_label.grid(row=4, column=0)
        self.y_label = tk.Label(sub_frame, text = "Y: ")
        self.y_label.grid(row=4, column=1)

        self.freq_label = tk.Label(sub_frame, text = "Frequency: ")
        self.freq_label.grid(row=5, column=0)
        self.angle_label = tk.Label(sub_frame, text="Angle: ")
        self.angle_label.grid(row=5, column=1)
        self.amplitude_label = tk.Label(sub_frame, text = "Amplitude: ")
        self.amplitude_label.grid(row=6, column=0)
